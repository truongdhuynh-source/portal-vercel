...
appendFile(arrayBuffer:Uint8Array):any;
  /**
* Internal implementation used by APIs of the Viewer.appendFileVsfx() function.
**/
appendFileVsfx(arrayBuffer:Uint8Array):any;
  /**
* Internal implementation used by APIs of the Viewer.appendFileVsfxAllModels() function.
**/
appendFileVsfxAllModels(arrayBuffer:Uint8Array):any;
  /**
...
**/
createRasterImageWithBinaryData(name:string, format:OdTvRasterImageFormat, width:number, height:number, data:Uint8Array, iAlignment:number):OdTvRasterImageId;
  /**
* Creates a palette-based binary raster image object and returns the appropriate ID.
**/
createRasterImageWithPalette(name:string, paletteformat:OdTvRasterImageFormat, paletteSize:number, paletteData:Uint8Array, bpi:OdTvRasterImageBitPerIndex, width:number, height:number, data:Uint8Array, iAlignment:number):OdTvRasterImageId;
  /**
* Creates a monochrome raster image object and returns the appropriate ID.
**/
createRasterImageWithMonochromeData(name:string, width:number, height:number, data:Uint8Array, bInverted:boolean, iAlignment:number):OdTvRasterImageId;
  /**
...
getEntityByOriginalHandle(originalDatabaseHandle:string):OdTvEntityId;
  /**
* Returns the OdTvEntityId that matches the original database handle represented as integer value.
**/
getEntityByOriginalIntHandle(originalDatabaseHandle:number):OdTvEntityId;
  /**
* Returns the set of OdTvEntityId that matches the original database handles from input array.
**/
getEntitySetByOriginalHandles(handles:any):OdTvSelectionSet;
  /**
* Returns the set of OdTvEntityId that matches the original database handles from input array represented as integer value.
**/
getEntitySetByOriginalIntHandles(handles:any):OdTvSelectionSet;
  /**
...
* Returns the OdTvEntityId that matches the original database handle.
**/
findEntityByIntHandle(originalDatabaseHandle:number):OdTvEntityId;
  /**
...
appendCamera(name:string, bNeedSaveInFile:boolean):OdTvEntityId;
  /**
* Appends a group object to the model and returns the identifier of the appended camera object.
**/
appendGroup(name:string):OdTvEntityId;
  /**
...
openObjectAsCamera():OdTvCamera;
  /**
* Opens the entity determined with its identifier as an <link OdTvGroup, OdTvGroup> object for a read or write operation.
**/
openObjectAsGroup():OdTvGroup;
  /**
...
**/
getExtentsByType(eType:ExtentsType):Extents3d;
  /**
...
**/
setClippingBoundary(points:VectorOdTvPoint2d, xToClipSpace:Matrix3d, xInverseInsertXForm:Matrix3d, frontClip:number, backClip:number, bDrawBoundary:boolean):void;
  /**
* Retrieves the current clipping boundary properties for the insert object. 
**/
getClippingBoundary():any;
    delete():void;
}
...
getName():string;
  /**
* Appends an entity object to the group and returns the identifier of the appended entity.
**/
appendEntity(name:string):OdTvEntityId;
  /**
* Appends an insert entity object to the group and returns the identifier of the appended insert entity.
**/
appendInsert(blockId:OdTvBlockId, name:string):OdTvEntityId;
  /**
* Appends a group object to the group and returns the identifier of the appended group entity.
**/
appendGroup(name:string):OdTvEntityId;
  /**
* Removes an entity object, specified by its identifier, from the group.
**/
removeEntity(id:OdTvEntityId):void;
  /**
* Retrieves a smart pointer to the entity iterator.
**/
getEntitiesIterator():OdTvEntitiesIterator;
  /**
* Returns true if and only if the group has no sub groups, entities or inserts.
**/
isEmpty():boolean;
  /**
* Sets a new visual style for the group. The visual style should be compatible with the visual style assigned to the view.
**/
setVisualStyle(vsId:OdTvVisualStyleId):void;
  /**
* Retrieves the current visual style applied to the group.
**/
...
appendSubEntity(name:string):OdTvGeometryDataId;
  /**
* Adds a sub group object to the entity.
**/
appendSubGroup(name:string):OdTvGeometryDataId;
  /**
...
**/
appendProgressiveMesh(points:any, faces:any):OdTvGeometryDataId;
  /**
* Add view in which entity will be drawn
**/
addViewDependency(viewId:View):void;
...
openAsGrid():OdTvGridData;
  /**
* Opens the geometry data object, determined with its identifier, as a sub group data object for a read or write operation.
**/
openAsSubGroup():OdTvSubGroupData;
  /**
* Opens the geometry data object, determined with its identifier, as a progressive mesh for a read or write operation.
**/
openAsProgressiveMesh():OdTvProgressiveMeshData;
    delete():void;
}
...
appendLight(name:string):OdTvEntityId;
  /**
* Appends a group object to the model and returns the identifier of the appended group object.
**/
appendGroup(name:string):OdTvEntityId;
  /**
...
**/
setReflectivity(reflectivity:number, type:MaterialReflectivityType, textureSourceFileName:string):void;
  /**
...
getTransparency():OdTvTransparencyDef;
  /**
* Sets the material for the .
**/
setMaterial(material:OdTvMaterialDef):void;
  /**
* Retrieves the current material applied to the .
**/
getMaterial():OdTvMaterialDef;
  /**
...
getViewDependencies():Viewports;
  /**
* Adds a simple line to the sub group.
**/
appendPolyline(start:Point3, end:Point3):OdTvGeometryDataId;
  /**
* Adds a polyline to the sub group.
**/
appendPolyline(points:any):OdTvGeometryDataId;
  /**
* Adds an unfilled circle to the sub group.
**/
appendCircle(firstPoint:Point3, secondPoint:Point3, thirdPoint:Point3):OdTvGeometryDataId;
  /**
* Adds an unfilled circle (via radius) to the sub group.
**/
appendCircleWithNormal(center:Point3, radius:number, normal:Vector3):OdTvGeometryDataId;
  /**
* Adds an unfilled circle arc to the sub group.
**/
appendCircleArc(startPoint:Point3, middlePoint:Point3, endPoint:Point3):OdTvGeometryDataId;
  /**
* Adds a circle wedge to the sub group.
**/
appendCircleWedge(startPoint:Point3, middlePoint:Point3, endPoint:Point3):OdTvGeometryDataId;
  /**
* Adds an unfilled ellipse to the sub group.
**/
appendEllipse(centerPoint:Point3, majorPoint:Point3, minorPoint:Point3):OdTvGeometryDataId;
  /**
* Adds an unfilled elliptical arc to the sub group.
**/
appendEllipticArc(centerPoint:Point3, majorPoint:Point3, minorPoint:Point3, startAng:number, endAng:number):OdTvGeometryDataId;
  /**
* Adds an unfilled polygon to the sub group.
**/
appendPolygon(points:any):OdTvGeometryDataId;
  /**
* Adds a shell to the sub group.
**/
appendShell(points:any, faces:any):OdTvGeometryDataId;
  /**
* Adds a cylinder to the sub group as a shell.
**/
appendShellFromCylinder(point1:Point3, point2:Point3, radius:number, caps:Capping, nDiv:number):OdTvGeometryDataId;
  /**
* Adds a cylinder to the sub group as a shell.
**/
appendShellFromCylinder(points:any, radii:any, caps:Capping, nDiv:number):OdTvGeometryDataId;
  /**
* Adds a sphere to the sub group as a shell.
**/
appendShellFromSphere(center:Point3, radius:number, axis:Vector3, primeMeridian:Vector3, nDiv:number):OdTvGeometryDataId;
  /**
* Adds a box to the sub group as a shell.
**/
appendShellFromBox(centerPt:Point3, dLength:number, dWidth:number, dHeight:number, baseNormal:Vector3, lengthDir:Vector3):OdTvGeometryDataId;
  /**
* Adds a mesh to the sub group.
**/
appendMesh(nRows:number, nColumns:number, verticesArray:any):OdTvGeometryDataId;
  /**
* Adds a sphere to the sub group.
**/
appendSphere(center:Point3, radius:number, axis:Vector3, primeMeridian:Vector3):OdTvGeometryDataId;
  /**
* Adds a cylinder to the sub group.
**/
appendCylinder(point1:Point3, point2:Point3, radius:number, caps:Capping):OdTvGeometryDataId;
  /**
* Adds a cylinder to the sub group.
**/
appendCylinder(points:any, radii:any, caps:Capping):OdTvGeometryDataId;
  /**
* Adds a box to the sub group.
**/
appendBox(centerPt:Point3, dLength:number, dWidth:number, dHeight:number, baseNormal:Vector3, lengthDir:Vector3):OdTvGeometryDataId;
  /**
* Adds a text to the sub group.
**/
appendText(ref_point:Point3, msg:string):OdTvGeometryDataId;
  /**
* Adds a NURBS to the sub group.
**/
appendNurbs(degree:number, controlPoints:any, weights:any, knots:any, start:number, end:number):OdTvGeometryDataId;
  /**
* Adds an infinite line to the sub group.
**/
appendInfiniteLine(first:Point3, second:Point3, ilt:InfiniteLineType):OdTvGeometryDataId;
  /**
* Adds an image to the sub group.
**/
appendRasterImage(imageId:OdTvRasterImageId, origin:Point3, u:Vector3, v:Vector3):OdTvGeometryDataId;
  /**
* Adds a point cloud to the sub group.
**/
appendPointCloud(points:any):OdTvGeometryDataId;
  /**
* Adds a grid to the sub group.
**/
appendGrid(origin:Point3, firstPoint:Point3, secondPoint:Point3, firstCount:number, secondCount:number, type:GridDataType):OdTvGeometryDataId;
  /**
* Adds a plane colored area to the sub group.
**/
appendColoredShape(points:any, faces:any):OdTvGeometryDataId;
  /**
* Adds an insert object to the sub group.
**/
appendInsert(blockId:OdTvBlockId):OdTvGeometryDataId;
  /**
...
getGeometryDataIterator():OdTvGeometryDataIterator;
  /**
* Adds a progressive mesh to the sub group.
**/
appendProgressiveMesh(points:any, faces:any):OdTvGeometryDataId;
    delete():void;
}
...
class OdTvCustomInterpolation {
  /**
* Calculates the function value f( x ) with conditions: f( minX ) = minY, f( maxX ) = maxY.
**/
interpolate(minX:number, minY:number, maxX:number, maxY:number, x:number):number;
    delete():void;
}
...
**/
class OdTvProgressiveMeshData {
  /**
* Check if this object is NULL.
**/
isNull():boolean;
  /**
* Gets the geometry data of progressive mesh on current LOD if a progressive mesh is generated. Otherwise gets the geometry data of an initial shell.
**/
getParam():any;
  /**
* Sets normal vectors for a list of initial shell vertices.
**/
setVertexNormalsViaList(indVertices:any, vectors:any):void;
  /**
* Sets normal vectors for a list of initial shell vertices.
...
setVertexNormalViaList(indVertices:any, vector:Vector3):void;
  /**
* Sets normal vectors for a range of initial shell vertices.
**/
setVertexNormalViaRange(indStart:number, nCount:number, vector:Vector3):void;
  /**
* Sets normal vectors for a range of initial shell vertices.
...
setVertexNormalsViaRange(indStart:number, vectors:any):void;
  /**
* Retrieves normal vectors for a range of progressive meshes on the current LOD if a progressive mesh is generated. Otherwise retrieves the normal vectors for a range of initial shell data.
**/
getVertexNormalsViaRange(indStart:number, nCount:number):any;
  /**
* Retrieves normal vectors for a list of progressive meshes on the current LOD if a progressive mesh is generated. Otherwise retrieves the normal vectors for a list of initial shell data.
**/
getVertexNormalsViaList(indVertices:any):any;
  /**
* Retrieves the normal vector for a specified progressive mesh vertex on the current LOD if a progressive mesh is generated. Otherwise retrieves the normal vector for a specified initial shell vertex.
**/
getVertexNormal(ind:number):Vector3;
  /**
* Sets colors for a list of initial shell vertices.
**/
setVertexColorsViaListUseArray(indVertices:any, colors:any):void;
  /**
* Sets a color for a list of initial shell vertices.
**/
setVertexColorsViaList(indVertices:any, color:OdTvRGBColorDef):void;
  /**
* Sets a color for a range of initial shell vertices.
**/
setVertexColorsViaRange(indStart:number, nCount:number, color:OdTvRGBColorDef):void;
  /**
* Sets a color for a range of initial shell vertices.
...
setVertexColorsViaRangeUseArray(indStart:number, colors:any):void;
  /**
* Retrieves colors for a range of progressive meshes on the current LOD if a progressive mesh is generated. Otherwise retrieves colors for a range of initial shell data.
**/
getVertexColorsViaRange(indStart:number, nCount:number):any;
  /**
* Retrieves colors for a list of progressive meshes on the current LOD if a progressive mesh is generated. Otherwise retrieves colors for a list of of initial shell data.
**/
getVertexColorsViaList(indVertices:any):any;
  /**
* Retrieves the color for a specified progressive mesh vertex on the current LOD if a progressive mesh is generated. Otherwise retrieves the color for a specified initial shell vertex.
**/
getVertexColor(ind:number):OdTvRGBColorDef;
  /**
...
setVertexMappingCoordViaList(indVertices:any, mappingCoord:VectorOdTvPoint2d):void;
  /**
* Sets mapping coordinates for a range of initial shell vertices.
**/
setVertexMappingCoordsViaRange(indStart:number, mappingCoords:any):void;
  /**
* Sets mapping coordinates for a range of initial shell vertices.
...
setVertexMappingCoordViaRange(indStart:number, nCount:number, mappingCoord:VectorOdTvPoint2d):void;
  /**
* Retrieves mapping coordinates for a range of progressive meshes on the current LOD if a progressive mesh is generated. Otherwise retrieves mapping coordinates for a range of initial shell data.
**/
getVertexMappingCoordsViaRange(indStart:number, nCount:number):any;
  /**
* Retrieves mapping coordinates for a list of progressive meshes on the current LOD if a progressive mesh is generated. Otherwise retrieves mapping coordinates for a list of initial shell data.
**/
getVertexMappingCoordsViaList(indVert:any):any;
  /**
* Retrieves mapping coordinates for a specified progressive mesh vertex on the current LOD if a progressive mesh is generated. Otherwise retrieves mapping coordinates for a specified initial shell vertex.
**/
getVertexMappingCoord(ind:number):VectorOdTvPoint2d;
  /**
* Sets colors for a list of initial shell faces.
**/
setFaceColorsViaListUseArray(indFaces:any, colors:any):void;
  /**
...
**/
setFaceColorsViaRangeUseArray(indStart:number, colors:any):void;
  /**
* Retrieves color definition objects for a range of progressive meshes on the current LOD if a progressive mesh is generated. Otherwise retrieves color definition objects for a range of initial shell data.
**/
getFaceColorsViaRange(indStart:number, nCount:number):any;
  /**
* Retrieves color definition objects for a list of progressive meshes on the current LOD if a progressive mesh is generated. Otherwise retrieves color definition objects for a list of initial shell data.
**/
getFaceColorsViaList(indFaces:any):any;
  /**
* Retrieves a color definition object for a specified face of a progressive mesh on the current LOD if a progressive mesh is generated. Otherwise retrieves a color definition object for a specified face of initial shell face.
**/
getFaceColor(ind:number):OdTvColorDef;
  /**
* Sets material definition objects for a list of initial shell faces.
**/
setFaceMaterialsViaListUseArray(indFaces:any, materials:any):void;
  /**
* Sets material definition objects for a list of initial shell faces.
**/
setFaceMaterialsViaList(indFaces:any, material:OdTvMaterialDef):void;
...
**/
setFaceMaterialsViaRangeUseArray(indStart:number, materials:any):void;
  /**
* Retrieves material definition objects for a range of progressive mesh faces on the current LOD if a progressive mesh is generated. Otherwise retrieves material definition objects for a range of initial shell data faces.
**/
getFaceMaterialsViaRange(indStart:number, nCount:number):any;
  /**
* Retrieves material definition objects for a list of progressive mesh faces on the current LOD if a progressive mesh is generated. Otherwise retrieves material definition objects for a list of initial shell data faces.
**/
getFaceMaterialsViaList(indFaces:any):any;
  /**
* Retrieves material definition objects for a specified face of a progressive mesh on the current LOD if a progressive mesh is generated. Otherwise retrieves material definition objects for a specified face of initial shell face.
**/
getFaceMaterial(ind:number):OdTvMaterialDef;
  /**
* Sets visibility data for a list of initial shell edges.
**/
setEdgeVisibilitiesViaListUseArray(indEdges:any, visibilities:any):void;
  /**
* Sets visibility data for a list of initial shell edges.
**/
setEdgeVisibilitiesViaList(indEdges:any, visibility:OdTvVisibilityDef):void;
...
* Sets visibility data for a range of initial shell edges.
**/
setEdgeVisibilitiesViaRangeUseArray(indStart:number, visibilities:any):void;
  /**
* Retrieves visibility data for a range of progressive mesh edges on the current LOD if a progressive mesh is generated.
**/
getEdgeVisibilitiesViaRange(indStart:number, nCount:number):any;
  /**
* Retrieves visibility data for a list of progressive mesh edges on the current LOD if a progressive mesh is generated. Otherwise retrieves visibility data for a list of initial shell data edges.
**/
getEdgeVisibilitiesViaList(indEdges:any):any;
  /**
* Retrieves the visibility data object for a specified edge of a progressive mesh on the current LOD if a progressive mesh is generated.
**/
getEdgeVisibility(ind:number):OdTvVisibilityDef;
  /**
* Builds a progressive mesh.
**/
buildProgressiveMesh(nMinPoints:number, nMinFaces:number):void;
  /**
* Retrieves a number of level of details.
**/
numLODs():number;
  /**
* Retrieves the current level of details.
**/
currentLOD():number;
  /**
* Switches a progressive mesh to the specified level of detail.
**/
setLOD(lod:number):void;
  /**
* Retrieves the number of faces on the current level of details.
**/
numFaces():number;
  /**
* Retrieves the number of vertices on the current level of details.
**/
numVertices():number;
  /**
* Checks whether the progressive mesh ignores face normals while drawing.
**/
getIgnoreFaceNormals():boolean;
  /**
* Specifies whether the progressive mesh ignores face normals while drawing.
**/
setIgnoreFaceNormals(bIgnore:boolean):void;
  /**
* Checks whether the progressive mesh is successfully built from input data.
**/
isProgressiveMeshGenerated():boolean;
  /**
* Specifies how the progressive mesh automatically selects the level of details while drawn.
**/
setAutoLODSelectionEnum(autoSelectType:OdTvProgressiveMeshLODAutoSelectType):void;
  /**
* Specifies how the progressive mesh automatically selects the level of details while drawn.
**/
setAutoLODSelection(autoSelectType:number):void;
  /**
* Retrieves the current automatic level of details selection type.
**/
getAutoLODSelectionEnum():OdTvProgressiveMeshLODAutoSelectType;
  /**
* Retrieves the current automatic level of details selection type as int value.
**/
getAutoLODSelection():number;
  /**
* Returns Level of details automatic select interpolation thresholds.
**/
getAutoLODSelectInterpolationThresholds():any;
  /**
* Specifies Level of details automatic select interpolation thresholds.
**/
setAutoLODSelectInterpolationThresholds(nMin:number, nMax:number):void;
  /**
* Specifies interpolation callback for kAutoLOD_CustomInterpolation.
**/
setAutoLODCustomInterpolation(pInterpolation:any):void;
  /**
* Returns interpolation callback for kAutoLOD_CustomInterpolation.
**/
getAutoLODCustomInterpolation():any;
  /**
* Checks whether a progressive mesh is in partial mode.
**/
isInPartialMode():boolean;
  /**
...
kCamera: OdTvEntityType,
  /**
* A group object. Scene object.
**/
kGroup: OdTvEntityType
}
...
* Quantity of cameras.
**/
kCamera: GeometryStatisticTypes,
  /**
* Quantity of groups.
**/
kGroup: GeometryStatisticTypes,
  /**
* Quantity of subgroups.
**/
kSubGroup: GeometryStatisticTypes
}
...
const OdTvGeometryDataType: {
  ...
  kSubGroup: OdTvGeometryDataType
}
...
**/
type OdTvRasterImageFormat = { value: number }
const OdTvRasterImageFormat: {
  /**
* RGB format.
**/
kRGB: OdTvRasterImageFormat,
  /**
* RGB with alpha channel format.
**/
kRGBA: OdTvRasterImageFormat,
  /**
* BGR format.
**/
kBGR: OdTvRasterImageFormat,
  /**
* BGR with alpha channel format.
**/
kBGRA: OdTvRasterImageFormat,
  /**
* 16-bit BGR format.
**/
kBGR_16: OdTvRasterImageFormat
}

/**
* Bits per index for palette binary image data.
**/
type OdTvRasterImageBitPerIndex = { value: number }
const OdTvRasterImageBitPerIndex: {
  /**
* Four bits per index.
**/
kFourBits: OdTvRasterImageBitPerIndex,
  /**
* Eight bits per index.
**/
kEightBits: OdTvRasterImageBitPerIndex
}
...
**/
type OdTvProgressiveMeshLODAutoSelectType = { value: number }
const OdTvProgressiveMeshLODAutoSelectType: {
  /**
* No auto select
**/
kAutoLOD_None: OdTvProgressiveMeshLODAutoSelectType,
  /**
* Square interpolation
**/
kAutoLOD_SqrInterpolation: OdTvProgressiveMeshLODAutoSelectType,
  /**
* Square root interpolation
**/
kAutoLOD_SqrtInterpolation: OdTvProgressiveMeshLODAutoSelectType,
  /**
* Custom interpolation using OdTvCustomInterpolation
**/
kAutoLOD_CustomInterpolation: OdTvProgressiveMeshLODAutoSelectType
}
